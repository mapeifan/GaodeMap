...
public class TTSController implements MyNaviListener {
     ...
     * 请替换您自己申请的ID。
     */
    private final String appId = "59146818";  //59146818  5350db8d
    ...
    public void init() {
        //设置发音人
        mTts.setParameter(SpeechConstant.VOICE_NAME, "xiaoyan");   //xiaoyan 支持年轻女声小燕，年轻男声小宇，中老年男声老孙，可爱蜡笔小新等声音
